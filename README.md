...
This is the output if we input 1 in the fourth interface. First, it will ask the user to choose which item depending on the category to be deleted, then it will ask the index number of the item in the table. I double check the user if they input non-numbers and the index number that is in the table.
(BELOM)
