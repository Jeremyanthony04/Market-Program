...
This is the output if we input 1 in the second interface. First, this input will ask what item you want to add depending on the chosen category, then it will ask what is the name of the item, the stock, price, brand, and the date of production. After that, it will make sure if you really want to add the item.
...
This is the output if we input 1 in the fourth interface. First, it will ask the user to choose which item depending on the category to be deleted, then it will ask the index number of the item in the table. After that, it will ask the user if they really want to delete the item.

<img width="636" alt="Screen Shot 2023-04-27 at 20 49 38" src="https://user-images.githubusercontent.com/102398975/234882902-c3a78eed-7183-4ab1-adb5-f879fbea544a.png">
...
<img width="668" alt="Screen Shot 2023-04-27 at 20 34 07" src="https://user-images.githubusercontent.com/102398975/234879410-1ff4b2a8-41b0-439d-89bb-e1e7eb61141e.png">
